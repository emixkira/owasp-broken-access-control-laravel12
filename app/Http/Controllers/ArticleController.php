...
class ArticleController extends Controller
{
    ...
    // SECURE XSS VERSION - verrà trattata nella relativa esercitazione
    // public function show(
    //     Article $article,
    //     Request $request,
    ...
    /*
    |--------------------------------------------------------------------------
    | EDIT - BROKEN ACCESS CONTROL MITIGATION
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | UPDATE - BROKEN ACCESS CONTROL MITIGATION
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | DESTROY - BROKEN ACCESS CONTROL MITIGATION
    |--------------------------------------------------------------------------
    */
