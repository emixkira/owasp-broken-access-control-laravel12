        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                type="email"
                                name="email"
                                placeholder="Your brand new email"
                ...
                <div class="card shadow-sm border-0 p-4 mb-4">
                    ...
                    <a
                        href="{{ route('download', 'filename=privacy.pdf') }}"
                        class="d-block mb-2 text-decoration-none text-info fw-semibold"
                    >
                    ...
                    <a
                        href="{{ route('download', 'filename=cookie-policy.pdf') }}"
                        class="d-block text-decoration-none text-info fw-semibold"
                    >
                        <i class="bi bi-file-earmark-pdf me-2"></i>
                        Cookie policy
                    </a>
